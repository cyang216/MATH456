...
Females are 2.83 times as likely to be depressed compared to males (95% CI 1.35, 5.91).
...
We'll get to how to calculate a CI for the OR a little later. 
...
* 
* The Adjusted odds ratio for increase of 1 year of age is 0.98.
...
* In fact a very _incorrect_ way to interpret the above would be to take the probability
  of dying for males and multiply it by 2.3. (2.3*4 = .92).  
