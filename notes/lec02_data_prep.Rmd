...
* Complete case analysis
    - Ignore it. Drop all records with missing data
    - Do this for now.
```{r}
mean(survey$Pulse, na.rm=TRUE) # complete case on a single variable
survey <- survey[!is.na(survey$Pulse),]
library(dplyr)
survey <- survey %>% !is.na(Pulse) 
...
## New varaibles created using transformations of existing variables
