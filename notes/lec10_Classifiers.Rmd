...
The stepwise LDA
procedure is _very_ verbose (it creates a lot of output) so I specifically
am NOT showing the results here. (I put ` ```{r, results='hide'} ` in the 
code chunk header).
...
test.logreg
```
Boosted Logistic Regresssion had perfect prediction!
